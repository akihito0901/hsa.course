...
const CATEGORIES = [
  ...
  },
  {
    ...
    desc:'note・Brainでの販売からSNS集客まで。少し上級者向けの会員限定コンテンツです。',
    lessons:[
      {t:'コンテンツ販売とは（稼ぎの全体像）', d:'自分の知識を商品にして売る、全体像。', min:12, url:'lessons/sales-1.html'},
      {t:'何を売る？売れるテーマの見つけ方（AIで発掘）', d:'AIも使って、売れるテーマを探します。', min:12, url:'lessons/sales-2.html'},
      {t:'noteで販売してみよう', d:'手軽なnoteで、販売の第一歩を踏み出す。', min:13, url:'lessons/sales-3.html'},
      {t:'Brainで販売してみよう', d:'紹介機能のあるBrainで販売を広げる。', min:12, url:'lessons/sales-4.html'},
      {t:'価格の決め方', d:'安売りにならない、納得感のある価格設定。', min:10, url:'lessons/sales-5.html'},
      {t:'AIを使った販売ページ（記事）の書き方', d:'AIを活用して、売れる販売文を作る。', min:14, url:'lessons/sales-6.html'},
      {t:'SNSで見込み客を集める動線設計', d:'各SNSから販売ページへ人を呼び込む。', min:14, url:'lessons/sales-7.html'},
      {t:'Xでバズらせて記事に呼び込む', d:'拡散を狙い、コンテンツに人を集める。', min:13, url:'lessons/sales-8.html'},
      {t:'自分の商品・サービスを作る', d:'売れる感覚をつかんだら、オリジナルへ。', min:16, url:'lessons/sales-9.html'},
      {t:'販売の仕組みを自動化する', d:'繰り返し売れる導線を、仕組み化します。', min:12, url:'lessons/sales-10.html'},
    ]
  },
];
